...
public class City {
    ...
    public City(){
        ...
        Doctor newDoctor=new Doctor("Doc1","D1",1,"",1234567890,"fdsa","Cardiology");
        Doctor newDoctor1=new Doctor("Doc2","D2",1,"",1234567890,"","Neurology");
        ...
        Doctor newDoctor2=new Doctor("Doc3","D3",1,"",1234567890,"","Cardiology");
        Doctor newDoctor3=new Doctor("Doc4","D4",1,"",1234567890,"","Urology");
        ...
        Doctor newDoctor4=new Doctor("Doc5","D5",1,"",1234567890,"","Dermatology");
        Doctor newDoctor5=new Doctor("Doc6","D6",2,"",1234567890,"","Neurology");
        ...
        Doctor newDoctor6=new Doctor("Doc7","D7",1,"",1234567890,"","Urology");
        Doctor newDoctor7=new Doctor("Doc8","D8",1,"",1234567890,"","Dermatology");
